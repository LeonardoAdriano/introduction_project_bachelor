...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { city: @tour.city, driver_name: @tour.driver_name, name: @tour.name } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { city: @tour.city, driver_name: @tour.driver_name, name: @tour.name } }
